...
<a id="nestedblock--private_preshared_key"></a>
### Nested Schema for `private_preshared_key`

Required:

- `network_id` (String) ID of the network (VLAN) a client using this passphrase should be placed on.
- `password` (String, Sensitive) The pre-shared key for this entry. Must be between 8 and 255 characters.
